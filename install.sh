...
if [ "$PACKAGE_VERSION" = "latest" ]; then
    PACKAGE_URL="https://stader-cli-permissioned.s3.amazonaws.com/latest/stader-node-install.tar.xz"
else
    PACKAGE_URL="https://stader-cli-permissioned.s3.amazonaws.com/$PACKAGE_VERSION/stader-node-install.tar.xz"
fi
