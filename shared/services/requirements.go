...
func RequireNodePassword(c *cli.Context) error {
	...
	if !nodePasswordSet {
		return errors.New("The node password has not been set. Please run './stader-permissioned-cli wallet init' and try again.")
	}
	return nil
}
...
func RequireNodeWallet(c *cli.Context) error {
	...
	if !nodeWalletInitialized {
		return errors.New("The node wallet has not been initialized. Please run './stader-permissioned-cli wallet init' and try again.")
	}
	return nil
}
...
func RequireNodeRegistered(c *cli.Context) error {
	...
	if !nodeRegistered {
		return errors.New("The node is not registered with Stader. Please run 'stader-permissioned-cli node register' and try again.")
	}
	return nil
}
