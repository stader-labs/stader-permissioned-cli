...
func GetDepositDataSigningRoot(validatorPubKey string, withdrawCredentials common.Hash, eth2Config beacon.Eth2Config, amount uint64) (eth2.DepositDataNoSignature, [32]byte, error) {
	validatorPubKeyHex, err := types.HexToValidatorPubkey(validatorPubKey)
	if err != nil {
	...
	domainData, err := eth2types.ComputeDomain(eth2types.DomainDeposit, eth2Config.GenesisForkVersion, eth2types.ZeroGenesisValidatorsRoot)
	if err != nil {
		return eth2.DepositDataNoSignature{}, common.Hash{}, err
	}
